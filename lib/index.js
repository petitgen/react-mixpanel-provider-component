...
function withMixpanel(Component) {
  return function (props) {
    return /*#__PURE__*/_react.createElement(Component, _extends({}, props, {
...
var MixPanelProvider = function MixPanelProvider(_ref) {
  ...
  if (!!token) {
    _mixpanelBrowser["default"].init(token, config);
  }

  return /*#__PURE__*/_react.createElement(MixPanelContext.Provider, {
    value: {
      mixpanel: _mixpanelBrowser["default"]
    }
  }, children);
